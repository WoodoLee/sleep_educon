...
model = RecurrentClassifier(input_feature_size, embedding_dim, hidden_dim, output_size,model='LSTM',act_layer= nn.Sigmoid)
model = model.to(device)


print(f'LSTM, window = {time_window}s,sampling = {sampling_rate}s')
