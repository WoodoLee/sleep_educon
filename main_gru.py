...
model_GRU = RecurrentClassifier(feature_size, embedding_dim, hidden_dim, output_size,model='GRU')
model_GRU = model_GRU.to(device)
print('GRU, window = 500s,sampling = 10s')
train_net(model_GRU,train_dataloader,test_dataloader,n_iter=20,device=device)